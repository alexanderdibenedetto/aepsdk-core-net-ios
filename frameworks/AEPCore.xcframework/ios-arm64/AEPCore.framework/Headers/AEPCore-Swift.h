...
/// Responsible for retrieving the configuration of the SDK and updating the shared state and dispatching configuration updates through the <code>EventHub</code>
SWIFT_CLASS("_TtC7AEPCore13Configuration")
...
/// Invoked when the Configuration extension has been registered by the <code>EventHub</code>, this results in the Configuration extension loading the first configuration for the SDK
- (void)onRegistered;
/// Invoked when the Configuration extension has been unregistered by the <code>EventHub</code>, currently a no-op.
- (void)onUnregistered;
/// Configuration extension is always ready for an <code>Event</code>
...
/// Creates a new <code>EventHistoryResult</code> object.
/// \param count The number of occurrences in <code>EventHistory</code> of the <code>EventHistoryRequest</code> specified
///
/// \param oldest A date representing the oldest occurrence of the event found in <code>EventHistory</code>
///
/// \param newest A date representing the most recent occurrence of the event found in <code>EventHistory</code>
///
- (nonnull instancetype)initWithCount:(NSInteger)count oldest:(NSDate * _Nullable)oldest newest:(NSDate * _Nullable)newest OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// An <code>Extension</code> for <code>EventHub</code>. This serves no purpose other than to allow <code>EventHub</code> to share state.
SWIFT_CLASS("_TtC7AEPCore28EventHubPlaceholderExtension")
